...
# 1) Open doors and place vial on the scale
    ...
    wm.open_door()
    print("Placing vial…")
    ur.run_program("moveVialStorageToBalance.urp")
...
# 4) Retrieve powder, tare, and PAUSE for manual dispensing
   ...
   "Type 'continue' when done: ")
    ur.run_program("movePowderStorageToBalance.urp")
...
# 5) Return powder to storage
   ...
   "Type 'continue' when done: ")
    ur.run_program("movePowderSBalanceToStorage.urp")
...
# 6) Open doors and return vial
    ...
    "Type 'continue' when done: ")
    ur.run_program("moveVialSBalanceToStorage.urp")
